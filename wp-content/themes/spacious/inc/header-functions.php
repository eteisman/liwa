		...
		<section id="featured-slider">
			<div class="slider-cycle">
				...
				for( $i = 1; $i <= 5; $i++ ) {
					...
					$s = pll__('Slider Title '.$i);
					if ($s !== 'Slider Title '.$i) {
						$spacious_slider_title = $s;
					}					
					$spacious_slider_text = spacious_options( 'spacious_slider_text'.$i , '' );
					$s = pll__('Slider Text '.$i);
					if ($s !== 'Slider Text '.$i) {
						$spacious_slider_text = $s;
					}					
					...
					$s = pll__('Slider Button '.$i);
					if ($s !== 'Slider Button '.$i) {
						$spacious_slider_button_text = $s;
					}					
					$spacious_slider_link = spacious_options( 'spacious_slider_link'.$i , '#' );
                                        $s = pll__('Slider Link '.$i);
					if ($s !== 'Slider Link '.$i) {
						$spacious_slider_link = $s;
					}                    
